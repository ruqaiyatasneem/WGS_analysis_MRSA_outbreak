...
bwa index $REF
SAMPLES=("ERR070042""ERR070040" "ERR070033" "ERR070034" "ERR070036" "ERR070039" "ERR070042" "ERR070045" "ERR070042" "ERR070043" "ERR070044" "ERR070046" "ERR070047" "ERR070048" "ERR072246") 
...
do
	...
	READ2="${SAMPLE}_2.fastq"
      ...
      # extract SNPs
        gatk SelectVariants -R $REF -V ${SAMPLE}_raw-variants_snp.vcf --select-type SNP -O ${SAMPLE}_raw_variants-snp.vcf
